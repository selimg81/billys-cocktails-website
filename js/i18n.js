...
const TRANSLATIONS = {
  de: {
    ...
    'bar-regionen':'Wir sind vor allem in <a href="cocktail-catering-hamburg.html">Hamburg</a> unterwegs, dazu regelmäßig in <a href="cocktail-catering-berlin.html">Berlin</a>, in <a href="cocktail-catering-nrw.html">NRW</a> mit Köln und Düsseldorf sowie in <a href="barkeeper-hannover.html">Hannover</a>. Was das kostet, steht auf der Seite <a href="preise.html">Preise und Pakete</a>.',
    ...
    'ctower-hero-sub':'Beeindruckende Champagner Türme für eure Hochzeit, euer Firmenevent oder eure Privatfeier. Mit atemberaubendem Trockeneis-Effekt oder klassisch elegant. Immer individuell auf euch abgestimmt.',
    ...
    'ctower-c3-text':'Auf Wunsch liefern wir den Champagner gleich mit. Oder ihr stellt ihn selbst bereit; wir bauen auf und sorgen für den perfekten Auftritt.',
    ...
    /* barkeeper-mieten */
    'bk-footer':'Barkeeper mieten',
    'bk-leist-text':'Professionelles Barpersonal stundenweise buchen – mit oder ohne mobile Bar.',
    'bk-hero-label':'Professionelles Barpersonal',
    'bk-h1':'Barkeeper','bk-h1-em':'mieten',
    'bk-hero-sub':'Erfahrene Barkeeper:innen für euer Event – stundenweise buchbar, mit oder ohne mobile Bar. Hamburg, Berlin & NRW.',
    'bk-srv-label':'Flexible Optionen',
    'bk-srv-h2':'Wann lohnt sich','bk-srv-h2-em':'ein Barkeeper?',
    'bk-srv-sub':'Ob du nur eine Fachkraft für eure bestehende Bar suchst oder ein komplettes Team mit mobiler Bar und allem Drum und Dran – wir passen uns flexibel an euren Bedarf an.',
    'bk-c1-title':'Nur Barpersonal','bk-c1-text':'Ihr habt bereits eine Bar oder einen Bestand – ihr braucht nur erfahrene Hände dahinter. Wir stellen professionelles Personal, das reibungslos einspringt.',
    'bk-c2-title':'Team für große Events','bk-c2-text':'Bei großen Veranstaltungen mit hohem Andrang stellen wir ein eingespieltes Team auf. Head Barkeeper inklusive, damit Qualität und Ablauf stimmen.',
    'bk-c3-title':'Mit mobiler Bar','bk-c3-text':'Kein Equipment vorhanden? Kein Problem. Wir kommen mit unserer kompakten mobilen Bar, allem Zubehör und liefern ein Rundum-Sorglos-Paket.',
    'bk-c4-title':'Kurzfristig buchbar','bk-c4-text':'Spontan entschieden oder ein Engpass entstanden? Bei freien Kapazitäten springen wir auch kurzfristig ein. Einfach anfragen.',
    'bk-price-label':'Transparente Stundensätze',
    'bk-price-h2':'Was kostet ein','bk-price-h2-em':'Barkeeper?',
    'bk-price-1-title':'Servicepersonal','bk-price-2-title':'Barkeeper:in','bk-price-3-title':'Head Barkeeper:in',
    'bk-price-unit':'pro Stunde',
    'bk-price-note':'Vollständige Pakete mit mobiler Bar ab 450 € netto. Unverbindliches Angebot auf Anfrage.',
    'bk-faq-label':'Häufige Fragen',
    'bk-faq-h2':'Barkeeper mieten','bk-faq-h2-em':'– alle Antworten',
    'bk-faq1-q':'Was kostet ein Barkeeper zu mieten?',
    'bk-faq1-a':'Unsere Stundensätze: Servicepersonal ab 45 €/h, Barkeeper:in ab 60 €/h, Head Barkeeper:in ab 80 €/h. Für vollständige Pakete inklusive mobiler Bar und Getränken beginnen die Preise ab 450 € netto. Wir erstellen gerne ein individuelles Angebot für euer Event.',
    'bk-faq2-q':'Kann ich nur Barpersonal ohne mobile Bar buchen?',
    'bk-faq2-a':'Ja, absolut. Wenn du ausschließlich professionelles Barpersonal benötigst, stellen wir dir erfahrene Barkeeper:innen zur Verfügung – ob Unterstützung an einer bestehenden Bar oder ein komplettes Team. Wir passen uns flexibel an deine Anforderungen an.',
    'bk-faq3-q':'In welchen Städten sind Barkeeper von Billy\'s buchbar?',
    'bk-faq3-a':'Wir sind hauptsächlich in Hamburg aktiv, kommen aber auch regelmäßig nach Berlin, NRW (Köln, Düsseldorf), Hannover und weiteren Städten. Schick uns einfach eine Anfrage mit deinem Standort und Termin – wir prüfen die Verfügbarkeit schnell.',
    'bk-faq4-q':'Wie früh muss ich einen Barkeeper buchen?',
    'bk-faq4-a':'Am besten 4–6 Wochen im Voraus, damit dein Wunschtermin sicher verfügbar ist. Gerade an Wochenenden und in der Hochzeitssaison sind Kapazitäten schnell vergeben. Bei freien Kapazitäten sind auch kurzfristige Buchungen möglich – frag einfach an.',
    'bk-faq5-q':'Was ist im Barkeeper-Service inklusive?',
    'bk-faq5-a':'Du entscheidest, wie viel Unterstützung du benötigst. Auf Wunsch bringen wir mobile Bar, Gläser, Marken-Spirituosen, Zutaten sowie Auf- und Abbau. Oder wir stellen nur das Personal – ganz nach deinen Bedürfnissen und deinem Budget.',
  },
  ...
  en: {
    ...
    'bar-regionen':'We mainly work in <a href="cocktail-catering-hamburg.html">Hamburg</a>, and regularly in <a href="cocktail-catering-berlin.html">Berlin</a>, in <a href="cocktail-catering-nrw.html">NRW</a> including Cologne and Düsseldorf, as well as <a href="barkeeper-hannover.html">Hannover</a>. You will find all rates on our <a href="preise.html">pricing page</a>.',
    ...
    /* barkeeper-mieten */
    'bk-footer':'Hire a Bartender',
    'bk-leist-text':'Book professional bar staff by the hour – with or without a mobile bar.',
    'bk-hero-label':'Professional Bar Staff',
    'bk-h1':'Hire a','bk-h1-em':'Bartender',
    'bk-hero-sub':'Experienced bartenders for your event – bookable by the hour, with or without a mobile bar. Hamburg, Berlin & NRW.',
    'bk-srv-label':'Flexible Options',
    'bk-srv-h2':'When does a','bk-srv-h2-em':'bartender make sense?',
    'bk-srv-sub':'Whether you just need a skilled hand behind your existing bar or a full team with a mobile bar and everything included – we adapt flexibly to your needs.',
    'bk-c1-title':'Bar Staff Only','bk-c1-text':'You already have a bar or supplies – you just need experienced hands behind it. We provide professional staff who seamlessly step in.',
    'bk-c2-title':'Team for Large Events','bk-c2-text':'For large events with high demand we put together a well-rehearsed team. Head bartender included to ensure quality and smooth service.',
    'bk-c3-title':'With Mobile Bar','bk-c3-text':'No equipment? No problem. We arrive with our compact mobile bar, all accessories, and deliver a complete worry-free package.',
    'bk-c4-title':'Short-notice Bookings','bk-c4-text':'Last-minute decision or a staffing gap? Subject to availability we can step in on short notice. Just get in touch.',
    'bk-price-label':'Transparent Hourly Rates',
    'bk-price-h2':'What does a','bk-price-h2-em':'bartender cost?',
    'bk-price-1-title':'Service Staff','bk-price-2-title':'Bartender','bk-price-3-title':'Head Bartender',
    'bk-price-unit':'per hour',
    'bk-price-note':'Complete packages with mobile bar from €450 net. Non-binding quote on request.',
    'bk-faq-label':'Frequently Asked Questions',
    'bk-faq-h2':'Hiring a bartender','bk-faq-h2-em':'– all the answers',
    'bk-faq1-q':'How much does it cost to hire a bartender?',
    'bk-faq1-a':'Our hourly rates: service staff from €45/h, bartender from €60/h, head bartender from €80/h. Complete packages including mobile bar and drinks start from €450 net. We\'re happy to create a tailored quote for your event.',
    'bk-faq2-q':'Can I book bar staff without a mobile bar?',
    'bk-faq2-a':'Yes, absolutely. If you only need professional bar staff, we provide experienced bartenders – whether to support an existing bar or as a complete team. We adapt flexibly to your requirements.',
    'bk-faq3-q':'In which cities can I book a Billy\'s bartender?',
    'bk-faq3-a':'We are mainly based in Hamburg but regularly travel to Berlin, NRW (Cologne, Düsseldorf), Hanover, and other cities. Just send us an enquiry with your location and date – we\'ll check availability quickly.',
    'bk-faq4-q':'How far in advance do I need to book a bartender?',
    'bk-faq4-a':'Ideally 4–6 weeks in advance to secure your preferred date. Especially on weekends and during wedding season, slots fill up fast. Subject to availability, last-minute bookings are also possible – just enquire.',
    'bk-faq5-q':'What is included in the bartender service?',
    'bk-faq5-a':'You decide how much support you need. On request we bring the mobile bar, glassware, branded spirits, ingredients, and handle set-up and pack-down. Or we provide staff only – entirely according to your needs and budget.',
  }
};
