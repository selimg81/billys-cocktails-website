...
const TRANSLATIONS = {
  de: {
    ...
    'faq1-a':'Da jedes Event einzigartig ist, arbeiten wir nicht mit Standardpaketen, sondern entwickeln individuelle Konzepte, die zu deinem Anlass passen. Von der ersten Planung bis zum stilvollen Auftritt vor Ort kümmern wir uns um alles. Transparent kalkuliert, zuverlässig umgesetzt und eindrucksvoll serviert.',
    'faq2-q':'Kann ich bei Billy\'s auch nur Barpersonal buchen?',
    'faq2-a':'Ja, selbstverständlich. Wenn du ausschließlich professionelles Barpersonal benötigst, stellen wir dir erfahrene Barkeeper:innen zur Verfügung. Ob Unterstützung an einer bestehenden Bar oder ein komplettes Team, wir passen uns flexibel an deine Anforderungen an. Gerne erstellen wir dir ein unverbindliches Angebot.',
    ...
    'bar-regionen':'Wir sind vor allem in <a href="cocktail-catering-hamburg.html">Hamburg</a> unterwegs, dazu regelmäßig in <a href="cocktail-catering-berlin.html">Berlin</a>, in <a href="cocktail-catering-nrw.html">NRW</a> mit Köln und Düsseldorf sowie in <a href="barkeeper-hannover.html">Hannover</a>.',
    ...
    'bk-price-note':'Vollständige Pakete mit mobiler Bar auf Anfrage. Unverbindliches Angebot jederzeit.',
    ...
    'bk-faq1-a':'Wir arbeiten mit individuellen Angeboten statt mit festen Stundensätzen. Sag uns Datum, Ort, Gästezahl und die geplante Dauer, dann bekommst du ein konkretes Angebot für euer Event.',
  ...
  en: {
    ...
    'faq2-a':'Yes, absolutely. If you only need professional bar staff, we\'ll provide experienced bartenders for your event. Whether supporting an existing bar or covering a full event, we adapt flexibly to your needs. We\'re happy to put together a personalised quote.',
    ...
    'bar-regionen':'We mainly work in <a href="cocktail-catering-hamburg.html">Hamburg</a>, and regularly in <a href="cocktail-catering-berlin.html">Berlin</a>, in <a href="cocktail-catering-nrw.html">NRW</a> including Cologne and Düsseldorf, as well as <a href="barkeeper-hannover.html">Hannover</a>.',
    ...
    'bk-price-note':'Complete packages with mobile bar on request. Non-binding quote at any time.',
    ...
    'bk-faq1-a':'We work with individual quotes rather than fixed rates. Send us the date, location, number of guests and planned duration and we will get back to you with a concrete offer.',
